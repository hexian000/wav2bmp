...
int main(int ac, char **av) {
  ...
  desc.add_options()("help,h", "show this help message")(
      ...
      "resolution,r", po::value<double>(),
      "set horizontal resolution (default=16.0)")(
      "brightness,b", po::value<double>(),
      "set brightness factor (default=1e-3)")(
      "frequency,f", po::value<double>(),
      "set cut down frequency (default=440*32)")(
      "startfreq", po::value<double>(),
      "set start frequency (default=440/32)");
  options op;
